document.addEventListener('DOMContentLoaded', function() {
	...
	document.getElementById('editFacilityButton').addEventListener('click', function() {
		const updatedFacilityData = {
			...
			latitude: selectedLatitude !== null ? selectedLatitude : facility.latitude,
			longitude: selectedLongitude !== null ? selectedLongitude : facility.longitude
		};
		...
		.then(response => {
		    if (response.ok) {
		        ...
		        // console.log(document.getElementById('alertModalLabel'));
		        // console.log(document.getElementById('alertModalBody'));
